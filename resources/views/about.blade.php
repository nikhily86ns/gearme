				...
				<div class="container">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6">
							<img src="{{ asset('img/sb.png') }}" class="img-fluid" alt="" />
						</div>
							...
							<div class="team-slide item-slide">
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('img/team-1.jpg') }}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('img/team-2.jpg') }}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('img/team-3.jpg') }}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('img/team-4.jpg') }}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('img/team-5.jpg') }}" alt="" class="img-fluid" />
										</div>
								...
								<div class="single-team">
									<div class="team-grid">
										...
										<div class="teamgrid-user">
											<img src="{{ asset('img/team-6.jpg') }}" alt="" class="img-fluid" />
										</div>
			...
			<section>
				<div class="container">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6">
							<img src="{{ asset('img/vec-2.png') }}" class="img-fluid" alt="" />
						</div>
