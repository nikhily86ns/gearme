                    ...
                    <section class="msger">
                        ...
                        <main class="msger-chat">
                            <div class="msg left-msg">
                                <div
                                class="msg-img"
                                style="background-image: url('{{ asset('profile/'. $data->profileimage) }}');"
                                ></div>
                            ...
                            <div class="msg right-msg">
                                ...
                                style="background-image: url('{{ asset('profile/'. Auth::user()->profileimage) }}');"
                                ></div>
                        ...
                        <form class="msger-inputarea" action="{{ route('provider.sendChat') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="receiver_id" value="{{ $data->id }}" id="receiver_id">
                            <input type="hidden" name="user_id" value="{{ Auth::user()->id }}" id="user_id">
                            <input type="text" name="message" class="msger-input" id="message" placeholder="Enter your message...">
                            <button class="msger-send-btn" id="ajaxSubmit">Send</button>
                        </form>
                    </section>
            </div>
        </div>
