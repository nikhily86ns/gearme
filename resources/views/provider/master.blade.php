...
<!-- Mirrored from themezhub.net/resido-live-02/resido/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Oct 2021 06:18:21 GMT -->
	<head>
        ...
        <title>Capital Provider | @yield('title')</title>
									...
									<div class="dashboard-navbar">
										...
										<div class="d-navigation">
											<ul>
												...
												<li class="{{ Request::is('interestedInvestors') ? 'active' : '' }}"><a href="{{ route('provider.interestedInvetors') }}"><i class="ti-user"></i>Interested Investors</a></li>
