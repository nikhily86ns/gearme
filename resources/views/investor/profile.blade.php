							...
							<div class="dashboard-wraper">
								...
								<div class="form-submit">	
									...
									<div class="submit-section">
										<form action="updateInvestorProfile" method="POST" enctype="multipart/form-data">
										@csrf
											<div class="image-upload d-flex flex-column align-items-center text-center p-3 py-5">
												<label for="file-input">
													<img class="rounded-circle mt-5" width="200px" height="200px" src="{{ asset('profile/'. Auth::user()->profileimage) }}"/>
												</label>
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" name="" class="form-control" value="{{ Auth::user()->roles == 3 ? 'Property Investor' : '' }}">
												</div>
