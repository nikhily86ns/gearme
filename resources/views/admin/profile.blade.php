        ...
        <form action="updateProfile" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6"><label class="labels">Mobile Number</label><input type="text" class="form-control" name="phone" value="{{ $data->phone }}"></div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6 mt-2"><label class="labels">Email ID</label><input type="text" class="form-control" name="email" value="{{ $data->email }}" readonly></div>
                            </div>
                            <div class="row mt-3">
                ...
                <div class="col-md-3 py-5 border-right">
                    <form action="/resetAdminPassword" method="POST" enctype="multipart/form-data">
                        @csrf
